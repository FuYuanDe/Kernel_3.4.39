 ...
 */
static __devinit int ac100_device_init(struct ac100 *ac100, int irq)
{
	int ret;
...
static __devexit void ac100_device_exit(struct ac100 *ac100)
{
	mfd_remove_devices(ac100->dev);
}

static __devinit int ac100_i2c_probe(struct i2c_client *i2c,
...
static __devexit int ac100_i2c_remove(struct i2c_client *i2c)
{

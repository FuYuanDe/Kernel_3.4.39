...
extern void geth_rcv_hardtimer_func(void *dev_id);
extern void  sunxi_timer_init(unsigned long data);
extern void  sunxi_timer_exit(void);
extern int dispatch_match(struct sk_buff *skb);
extern int  dispatch_init(void);
#endif

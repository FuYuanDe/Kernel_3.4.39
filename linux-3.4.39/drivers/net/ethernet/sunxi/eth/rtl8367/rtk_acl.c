...
///-
#if 0
                if(RT_ERR_OK != rtk8367c_mirror_add2cpu(slot))
                {
                    printk(KERN_ERR "%s rtk8370_mirror_add2cpu slot %d error\n",
                        __FUNCTION__, slot);
                }
#endif
            }
...
///-
#if 0
                if(RT_ERR_OK != rtk8370_mirror_del2cpu(slot))
                {
                    printk(KERN_ERR "%s rtk8370_mirror_del2cpu slot %d error\n",
                        __FUNCTION__, slot);
                }
#endif
            }

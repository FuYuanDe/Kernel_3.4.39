...
#define DEF_PHY_HIGH_ZONE_ACL_FILTER_NUM    3
#define DEF_PHY_LOW_ZONE_ACL_FILTER_NUM     3
#define DEF_RTP_ZONE_ACL_FILTER_NUM         0
#define DEF_DYNAMIC_ZONE_ACL_FILTER_NUM     (RTL8367C_ACLRULENO - DEF_PHY_HIGH_ZONE_ACL_FILTER_NUM - DEF_PHY_LOW_ZONE_ACL_FILTER_NUM - DEF_RTP_ZONE_ACL_FILTER_NUM)
...
#define DYNAMIC_ZONE_ACL_FILTER_NUM (RTL8367C_ACLRULENO - PHY_HIGH_ZONE_ACL_FILTER_NUM - PHY_LOW_ZONE_ACL_FILTER_NUM - RTP_ZONE_ACL_FILTER_NUM)
...
#define RTK_MAX_NUM_OF_METER                        RTL8367C_ACLRULENO
...
typedef struct
{
    ...
    rtk_filter_activeport_t activeport; //ACL规则作用的物理端口
